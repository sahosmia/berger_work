...
CREATE TABLE `counters` (
  ...
  `counter_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(4, 'RUNNING PROJECTS', 405, NULL, '2021-12-14 02:58:06');
...
CREATE TABLE `pages` (
  ...
  `diarie_title` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `diarie_content` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `contact_bg` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `contact_head_logo` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `copywrite` text COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `contact_logo` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `massenger` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `md_speech` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `md_speech_img` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `chairman_speech` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `chairman_speech_img` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
(5, 'portfolio_5.jpg', 'Portfolio 5', '2021-12-01 23:34:18', NULL);
...
(2, 'slider_2.jpg', 'We Are Professional', 'For Your Dream Project', 'Contact Us', 'www.contact.us', 1, '2021-12-08 17:58:22', '2021-12-14 02:16:35'),
...
CREATE TABLE `socials` (
  ...
  `social_value` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
