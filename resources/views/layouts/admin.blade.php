    ...
    <div class="br-sideleft overflow-y-auto">
        ...
        <div class="br-sideleft-menu">
            ...
            <ul class="br-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('admin.home_page') }}" class="nav-link @yield('home_page')">Home
                        Page</a></li>
                <li class="nav-item"><a href="{{ route('admin.contact_page') }}"
                        class="nav-link @yield('contact_page')">Contact Page</a></li>
                <li class="nav-item"><a href="{{ route('admin.corporate_speech') }}"
                        class="nav-link @yield('corporate_speech_page')">Corporate Speech Page</a></li>
            </ul>


            <a href="{{ route('admin.sliders.index') }}" class="br-menu-link @yield('slider')">
                <div class="br-menu-item">
            ...
            <a href="{{ route('admin.portfolios.index') }}" class="br-menu-link @yield('portfolio')">
                <div class="br-menu-item">
            ...
            <a href="{{ route('admin.diaries.index') }}" class="br-menu-link @yield('diarie')">
                <div class="br-menu-item">
            ...
            <a href="{{ route('admin.counters.index') }}" class="br-menu-link @yield('counter')">
                <div class="br-menu-item">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-header wd-200">
                        <ul class="list-unstyled user-profile-nav">
                            <li><a href="{{ route('admin.edit_profile') }}"><i class="icon ion-ios-person"></i> Edit
                                    Profile</a></li>
